...
file_pattern = f"{method}*{env}*/training_summary.txt"
...
def non_inferiority_test(conventional, proposed, margin=-100, alpha=0.05):
    ...
    # t統計量とp値（片側）
    t_stat = (mean_diff - margin) / (std_err + 1e-10)
...
# proposed = [-296.67198229416874, -292.7160013763229, -299.3712766650706, -290.3915135487783, -304.48473754552504, -295.76714486512026, -308.84207087104215, -294.0548887142677, -296.2669535467134, -291.4243102779699]
...
# proposed = [4537.819704233409, 4333.224093964994, 4702.017593474808, 4414.33616338678, 4599.523392206929, 4520.732938785627, 4293.18194810131, 4443.085605637798, 5185.359546832347, 4624.062682571202]
